...
export type CategoriaCatalogo = "MANUTENCAO" | "DOCUMENTACAO" | "CUSTOS_FIXOS" | "COMBUSTIVEL" | "OUTROS";
...
export const CATALOGO_MESTRE: ItemCatalogo[] = [
  ...
  { idItem: "combustivel", nome: "Combustível (Gasolina/Etanol/Diesel)", categoria: "COMBUSTIVEL", sugestaoDurabilidadeKm: 10, aplicavelA: ["CARRO", "MOTO", "CAMINHAO"] },
  ...
  { idItem: "pneu_carro", nome: "Pneus", categoria: "MANUTENCAO", sugestaoDurabilidadeKm: 40000, aplicavelA: ["CARRO"] },
  { idItem: "pneu_moto", nome: "Pneus", categoria: "MANUTENCAO", sugestaoDurabilidadeKm: 15000, aplicavelA: ["MOTO"] },
  { idItem: "pneu_caminhao", nome: "Pneus", categoria: "MANUTENCAO", sugestaoDurabilidadeKm: 60000, aplicavelA: ["CAMINHAO"] },
  ...
  { idItem: "filtro_combustivel", nome: "Filtro de Combustível", categoria: "MANUTENCAO", sugestaoDurabilidadeKm: 15000, sugestaoDurabilidadeMeses: 12, aplicavelA: ["CARRO", "MOTO", "CAMINHAO"] },
  { idItem: "filtro_ar", nome: "Filtro de Ar do Motor", categoria: "MANUTENCAO", sugestaoDurabilidadeKm: 20000, sugestaoDurabilidadeMeses: 12, aplicavelA: ["CARRO", "MOTO", "CAMINHAO"] },
  { idItem: "filtro_cabine", nome: "Filtro de Cabine (Ar-Condicionado)", categoria: "MANUTENCAO", sugestaoDurabilidadeKm: 15000, sugestaoDurabilidadeMeses: 12, aplicavelA: ["CARRO", "CAMINHAO"] },
  { idItem: "revisao", nome: "Revisão do Veículo", categoria: "MANUTENCAO", sugestaoDurabilidadeKm: 5000, aplicavelA: ["CARRO", "MOTO", "CAMINHAO"] },
  { idItem: "amortecedores", nome: "Amortecedores", categoria: "MANUTENCAO", sugestaoDurabilidadeKm: 80000, aplicavelA: ["MOTO", "CARRO", "CAMINHAO"] },
  ...
  { idItem: "bateria", nome: "Bateria", categoria: "MANUTENCAO", sugestaoDurabilidadeMeses: 24, aplicavelA: ["CARRO", "MOTO", "CAMINHAO"] },
  ...
  { idItem: "aditivo_radiador", nome: "Aditivo do Radiador (Arrefecimento)", categoria: "MANUTENCAO", sugestaoDurabilidadeKm: 30000, sugestaoDurabilidadeMeses: 24, aplicavelA: ["CARRO", "MOTO", "CAMINHAO"] },
  ...
  { idItem: "seguro", nome: "Seguro Auto / Proteção Veicular", categoria: "CUSTOS_FIXOS", sugestaoDurabilidadeMeses: 12, aplicavelA: ["CARRO", "MOTO", "CAMINHAO"] },
  { idItem: "seguro_carga", nome: "Seguro de Carga / RCTR-C", categoria: "CUSTOS_FIXOS", sugestaoDurabilidadeMeses: 1, aplicavelA: ["CAMINHAO"] },
  { idItem: "financiamento", nome: "Financiamento", categoria: "CUSTOS_FIXOS", sugestaoDurabilidadeMeses: 12, aplicavelA: ["CARRO", "MOTO", "CAMINHAO"] },
